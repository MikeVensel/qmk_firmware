...
[_FL] = LAYOUT_60_ansi(
  ...
  _______,KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,RESET,_______,KC_CALCULATOR,KC_PGUP,KC_UP,KC_PGDOWN,KC_PSCREEN, KC_SCROLLLOCK, KC_PAUSE,_________, \
